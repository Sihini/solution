...
namespace solution
{
    public partial class workingDays : Form
    {
        ...
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-EB5SPN9;Initial Catalog=ITPMSOLUTION;Integrated Security=True");
        ...
        {
            if (updownDays.Text == String.Empty)
            {
                MessageBox.Show("Selected  to No of working days", "Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            else if (updownHrs.Text == string.Empty)
            {
                MessageBox.Show("Selected to Working Per Day Hours", "Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }

            else if (updownMin.Text == string.Empty)
            {
                MessageBox.Show("Selected to Working Per Day Minutes ", "Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            return true;
        }
